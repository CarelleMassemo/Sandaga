        ...
        <ScrollView vertical>
            <View style={{display:'flex',justifyContent:'center',flexDirection:'column'}}>
                <View style={{ backgroundColor: '#ffffcc' }}>
                    ...
                    <View style={{ marginLeft: 100, backgroundColor: '#fa8072', height: 50, width: 250, borderRadius: 30 }}>
                        <Text style={{ fontSize: 18, color: '#fff', justifyContent: 'center', alignContent: 'center', marginLeft: 60 }}>Find Nearest Store</Text>
                    </View>
                ...
                <ScrollView horizontal>
                    <View>
                        ...
                        <View style={{ backgroundColor: '#ffffff', height: ',height:700' }}>
                            ...
                            <View style={{ backgroundColor: 'gray', width: '50em', height: 10, borderRadius: 30, marginTop: 50 }}>
                                ...
                                <View style={{ backgroundColor: 'pink', width: '9em', height: 10, borderRadius: 30, marginTop: 10 }}> </View>
                            </View>
                            <View style={{ marginTop: '4em', backgroundColor: 'gray', width: '50em', height: 10, borderRadius: 50 }}>
                                <Text style={{ fontSize: 15, marginTop: '-2em' }}>Good Sugar<Text style={{ left: '1em', fontSize: 15 }}>12 g</Text><Text style={{ left: '44em', fontSize: 15 }}>5%</Text><Text style={{ left: '4em' }}>12 g</Text><Text style={{ left: '41em' }}></Text></Text>
                                <View style={{ backgroundColor: 'pink', width: '12em', height: 10, borderRadius: 30, marginTop: 10 }}> </View>
                            </View>
                        </View>
                    </View>
                </ScrollView>
